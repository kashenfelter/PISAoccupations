...
1. **Compare categories in time** plot display students' mean performance on vertical axis and year of study on horizontal axis.   <!-- The results are grouped by parents' occupation category written above the plots -->
...
2. **Compare two countries** plots students' mean performance on vertical axis. Some of questions it may answer are: 
    * Do the countries have similar structure?   <!-- wyjaśnić -->
...
This plot helps answer questions like:  
    * Did the structure of results change over years?   <!-- Tzn. czy któreś dzieci zaczęły pisać lepiej -->
    * Did the spread in results got bigger or smaller?  
    * Did the spread change because of one or more categories?   <!-- Improving/pogarszająće się -->
...
<!-- Dodać link do strony? Potrzeba jakiś danych kontaktowych -->
